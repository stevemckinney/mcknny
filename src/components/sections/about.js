    ...
    <React.Fragment>
      <section className={containerStyles}>
        <div className={contentStyles}>
          ...
          <p className="mb-5">
            You’ve read an article, viewed a product, on the web—once or twice, I’m sure—and something feels off. Maybe it’s the amount of time the page had taken to load. Maybe it’s how much your head is moving to compensate for long line lengths.
          </p>
          <p className="mb-5">
