...
const Header = (props) => {
  ...
  const headerStyles = `${props.className} ${styles.header} xsMax:px-4 xsMax:flex xsMax:justify-between xs:grid layout absolute md:fixed right-0 left-0 z-50 top-0 sm:py-6 lg:py-10 items-center text-pearl`;
