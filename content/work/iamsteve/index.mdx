...
<div className="scroll scroll-offset flex full gap-8 -mb-16 -ml-4 md:-ml-8">
...
<div className="content mt-16 figure">
...
<div className="scroll scroll-offset flex full gap-8 mb-8 mt-16 -ml-4 lg:-ml-8">
<Screen device="small" className="snap-start">
...
<div className="scroll scroll-offset flex full gap-8 mb-8 -ml-4 lg:-ml-8">
<Screen device="small" className="snap-start">
