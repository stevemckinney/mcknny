...
<div className="flex scroll full-right lg:col-start-3 xxxl:col-start-6 lg:col-span-10 gap-8 mt-16" style={{ padding: "2px" }}>
  <Story className="mr-8 w-3/4">
    <motion.svg
