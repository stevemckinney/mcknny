...
<div className="grid grid-cols-10 col-start-6 col-span-10 gap-8">
  <Story className="col-span-5">
    <svg width={128} height={10} viewBox="0 0 128 10" fill="none" className="mb-16">
      <path
  ...
  <Story className="col-span-5" style={{ gridColumnStart: 6}}>
    <svg width={128} height={10} viewBox="0 0 128 10" fill="none" className="mb-16">
      <path
