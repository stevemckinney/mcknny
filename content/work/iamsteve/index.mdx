---
title: iamsteve
description: Design blog with a renewed focus
...
<div className="grid content grid-cols-10 lg:col-start-3 xxxl:col-start-6 lg:col-span-10 gap-8 mt-16">
  <Story className="col-span-10 lg:col-span-5">
    <svg width={128} height={10} viewBox="0 0 128 10" fill="none" className="mdMax:mt-8 mb-8 md:mb-16">
      <path
...
<div className="scroll scroll-offset flex full gap-8 mt-16 -mb-16 -ml-4 lg:-ml-8">
<Screen device="small" className="snap-start">
...
<div className="scroll scroll-offset flex full mb-8 mt-16 -mb-16 -ml-1 md:-ml-8">
<Screen device="small" className="snap-start">
...
<div className="grid content grid-cols-10 lg:col-start-3 xxxl:col-start-6 lg:col-span-10 gap-8 mt-16 mb-10">
  <Story className="col-span-10 md:col-span-5">
