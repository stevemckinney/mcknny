...
<div className="flex gap-8 full col-start-4 -ml-8">
  <Screen device="small">

    ![Small screen version of the homepage](./iamsteve-home-small.png)

  </Screen>
  <Screen device="large">

    ![Large screen version of the homepage](./iamsteve-home-large.png)
...
<div className="grid grid-cols-10 col-start-6 col-span-10 gap-8 mt-16">
  <Story className="col-span-5">
